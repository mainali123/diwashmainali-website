                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">To reset your password, please ensure that you enter your
                                            correct email address in the field provided. We'll send a password reset
                                            link to your email, which you can use to reset your password. Please make
                                            sure to check your spam folder if you don't see the email in your inbox.</p>
                                    </div>
                                    <form class="user">
